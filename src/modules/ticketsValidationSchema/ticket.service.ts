...
import { CreateTicketType } from 'src/common/schemas/ticketSchema.schema';
import { UpdateTicketDto } from '../tickets/dto/updateTicket.dto';
...
export class TicketService {
  ...
  create(ticketData: CreateTicketType): Ticket {
